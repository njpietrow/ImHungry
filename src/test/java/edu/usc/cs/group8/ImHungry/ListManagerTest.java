...
public class ListManagerTest {
	...
	public void testFavorites() {
		...
		User falseUser = new User("Buster");
		...
		falseUser.addToFavorites(myRecipe);
		falseUser.addToFavorites(myRestaurant);
	...
	public void testToExplore() {
		...
		falseUser.addToToExplore(myRecipe);
		falseUser.addToToExplore(myRestaurant);
	...
	public void testDoNotShow() {
		...
		falseUser.addToDoNotShow(myRecipe);
		falseUser.addToDoNotShow(myRestaurant);

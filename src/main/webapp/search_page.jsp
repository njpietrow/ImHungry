			...
			<div class="row justify-content-center">
				<form id="feed_me_form" class="form-inline" action="IHSearch" name="only_form">
					 <div class="input_group"> 
						...
						<input class="form-control form-control-borderless" id="ex3" data-toggle="tooltip" title="Search radius in meters" data-placement="right" type="number" min="1" value="1000" name="num_miles" > 
					 </div>
				</form> 
			</div>
	       	<br>
